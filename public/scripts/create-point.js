...
const collextedItems = document.querySelector("input[name=items]")
...
function handleSelectdItem(event){
    ...
    //verificar se existem itens adicionados, se sim, pegar os itens selecionados
    ...
    collextedItems.value = selectedItems
}
